...
Guía ARQEVENT (patrones, buenas prácticas, operación): [messaging-event-gateway/docs/arqevent/README.md](https://github.com/cochiss/messaging-event-gateway/blob/main/docs/arqevent/README.md).
